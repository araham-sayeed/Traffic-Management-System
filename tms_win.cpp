...
public:
    ...
    int recordOfVehicle_1()
    {
        ...
        cin.ignore();
        getline(cin, text);
        fio.open("C:/Users/Dell/OneDrive/Desktop/TMS/RecordOfTheVehicles.txt", ios::app | ios::out | ios::in);
        fio << text << endl;
    ...
    {
        system("cls");
        string path = "C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\RecordOfTheVehicles.txt";
    ...
    int recordOfChallan_1()
    {
        ...
        cin.ignore();
        getline(cin, text);
        fio.open("C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\RecordOfTheChallan.txt", ios::app | ios::out | ios::in);
    ...
    {
        system("cls");
        string path = "C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\RecordOfTheChallan.txt";
        ifstream file(path.c_str());
        if (file.is_open())
        {
    ...
    int helpInfo()
    {
        ...
        case 1:
        {
            system("cls");
            string para;
            ifstream myfile("C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\HelplineNumbers.txt");
            if (myfile.is_open())
            {
        ...
        case 2:
        {
            system("cls");
            string line;
            ifstream myfile("C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\HBhopal.txt");
            if (myfile.is_open())
            {
        ...
        case 3:
        {
            system("cls");
            string line;
            ifstream myfile("C:\\Users\\Dell\\OneDrive\\Desktop\\TMS\\HNagpur.txt");
            if (myfile.is_open())
            {
                while (getline(myfile, line))
                {
